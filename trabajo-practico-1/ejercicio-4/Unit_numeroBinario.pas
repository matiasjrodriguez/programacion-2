...
var
  index, i, j, exponente, resultado: integer;
...
begin
  for i := 1 to 17 do
  begin
    if ((numeroBinario1[i] = 1) and (numeroBinario2[i] = 1)) or
      ((numeroBinario1[i] = 0) and (numeroBinario2[i] = 0)) then
    begin
...
var
  complemento: array [1 .. 17] of integer;
