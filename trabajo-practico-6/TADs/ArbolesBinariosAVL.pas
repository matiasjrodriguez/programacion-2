...
// crea el arbol vacio
Function ArbolAVL.Crear(avTipoClave: TipoDatosClave; alSize: LongInt)
  : Resultado;
Begin
  if alSize < MIN then
    Crear := CError;
...
Var
  ...
  Begin
    ...
    Begin
      If C > H Then
        H := C; // cada vez que llega a la hoja pregunta si la cantidad de pasos fue mayor que la de la hoja anterior
    End
    Else
    Begin
      Alt(P^.HI, C + 1);
